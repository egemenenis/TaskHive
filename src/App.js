  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light">
      <div className="container-fluid">
        <Link to="/" className="navbar-brand">TaskHive</Link>
        ...
        <Route path="*" element={
          <div className="row my-5">
              <div className="col text-center">
                <h4 className="display-5">The page you are looking for was not found.</h4>
                <Link to="/" className='mt-4 btn btn-primary btn-sm'>Return to Dashboard</Link>
              </div>
          </div>} />
      </Routes>
    </div>
