        ...
        <div className="row mb-3">
          <div className="col">
            <form onSubmit={handleSubmit}>
              <div className="row">
                <div className="col">
                  <input type="text" name="summary" placeholder="Loremi, ipsum dolor." className="form-control form-control-sm"
                    onChange={handleChange} value={values.summary} />
                  <div className="badge small bg-danger">{errors.summary}</div>
                </div>
                <div className="col">
                  <input type="text" name="description" placeholder="Lorem ipsum dolor sit amet." className="form-control form-control-sm"
                    onChange={handleChange} value={values.description} />
                  <div className="badge small bg-danger">{errors.description}</div>
                </div>
                <div className="col">
                ...
                <div className="col">
                  ...
                  <button type="button" className="btn btn-secondary btn-sm" onClick={() => setMode("list")}>
                    <i className="fa fa-times me-2"></i>Close</button>
                </div>
              </div>
            </form>
          </div>
